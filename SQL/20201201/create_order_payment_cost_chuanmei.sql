...
CREATE TABLE `order_payment_cost`  (
  ...
  `amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '应收金额',
  `exchange_rate` decimal(10, 2) NULL DEFAULT NULL COMMENT '汇率',
  `change_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '本币金额',
