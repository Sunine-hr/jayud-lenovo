--20201127 财务功能-应收对账明细表
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

-- ----------------------------
-- Table structure for order_receivable_bill_detail
-- ----------------------------
DROP TABLE IF EXISTS `order_receivable_bill_detail`;
CREATE TABLE `order_receivable_bill_detail`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '应收对账单详情ID',
  ...
  `make_user` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '生成账单人',
  ...
  `apply_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '开票状态 0-未申请  1-待审核 2-审核通过 3-审核驳回',
  `invoice_amount` decimal(10, 4) NULL DEFAULT NULL COMMENT '开票金额',
  `audit_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '审核状态',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '1' COMMENT '1-有效 0-无效',
  `push_kingdee_count` int(5) NULL DEFAULT NULL COMMENT '推送金蝶次数',
  ...
  `piece_num` int(5) NULL DEFAULT NULL COMMENT '订单维度的总件数',
  `weight` double NULL DEFAULT NULL COMMENT '订单维护的总重量',
  ...
  `local_amount` decimal(10, 4) NULL DEFAULT NULL COMMENT '费用类型/类别/名称维度的本币金额',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '应收出账记录详情表' ROW_FORMAT = DYNAMIC;
