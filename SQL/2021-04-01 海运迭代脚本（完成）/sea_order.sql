...
CREATE TABLE `sea_order`  (
  ...
  `audit_opinion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '审核意见',
  `audit_status` int(10) NULL DEFAULT NULL COMMENT '补料审核状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '海运订单表' ROW_FORMAT = Dynamic;
