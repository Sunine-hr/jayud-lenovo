package com.jayud.Inlandtransport.generator;
...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String[] models = {model+"\\"+model+"-model",
                model+"\\"+model+"-service",
                model+"\\"+model+"-web"};
    ...
    private static void shell(String model, String table) {
        ...
        dsc.setUrl("jdbc:mysql://113.100.140.251:6335/jayud_oms?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
        ...
        if (path.contains("service")) {
            ...
            focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return path + "/src/main/resources/com/jayud/"+mapperPath+"/mapper"
