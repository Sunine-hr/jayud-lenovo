...
public interface ICostGenreTaxRateService extends IService<CostGenreTaxRate> {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<com.jayud.auth.model.po.CostGenreTaxRate>
     **/
     ...
     * @param: costGenreTaxRate
     * @param: req
     * @return: java.util.List<com.jayud.auth.model.po.CostGenreTaxRate>
     **/
