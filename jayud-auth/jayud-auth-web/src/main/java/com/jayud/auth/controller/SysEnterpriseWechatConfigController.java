...
import com.jayud.auth.service.ISysEnterpriseWechatConfigService;
...
public class SysEnterpriseWechatConfigController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.jayud.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.jayud.auth.model.po.SysEnterpriseWechatConfig>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysEnterpriseWechatConfig
    * @param: req
    * @return: com.jayud.common.BaseResult<java.util.List<com.jayud.auth.model.po.SysEnterpriseWechatConfig>>
    **/
    @ApiOperation("列表查询数据")
