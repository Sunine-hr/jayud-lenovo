...
import com.jayud.auth.service.ISysWechatConfigService;
import com.jayud.auth.model.po.SysWechatConfig;
...
public class SysWechatConfigController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.jayud.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.jayud.auth.model.po.SysWechatConfig>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysWechatConfig
    * @param: req
    * @return: com.jayud.common.BaseResult<java.util.List<com.jayud.auth.model.po.SysWechatConfig>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-02-24
     * @param: id
     * @return: com.jayud.common.BaseResult<com.jayud.auth.model.po.SysWechatConfig>
     **/
    @ApiOperation("根据id查询")
