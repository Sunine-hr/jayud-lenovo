...
import com.jayud.common.enums.ReceiptNoticeStatusEnum;
...
public class QueryClientReceiptNoticeForm extends SysBaseEntity {
    ...
    @ApiModelProperty(value = "所属仓库Code")
    @NotBlank(message = "请选择仓库Code")
    ...
    @ApiModelProperty(value = "货主名称Code")
    @NotBlank(message = "请选择货主Code")
...
//    @NotBlank(message = "请填写收货通知单号")
    ...
    private List<QueryClientNoticeMaterialForm> noticeMaterialForms;

    @ApiModelProperty(value = "物料sn信息")
    private List<QueryClientNoticeSnMaterialForm> noticeSnMaterialForms;
    ...
    public void calculateTotalQuantity() {
        ...
        for (QueryClientNoticeMaterialForm noticeMaterialForm : noticeMaterialForms) {
