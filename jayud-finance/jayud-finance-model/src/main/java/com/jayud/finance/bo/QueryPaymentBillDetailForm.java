...
public class QueryPaymentBillDetailForm extends BasePageForm {
    ...
    @Pattern(regexp = "(main_statement|zgys_statement|bg_statement|ky_statement" +
            ...
            "|cw_statement|hy_statement|hy_statement_audit|nl_statement|nl_statement_audit|tc_statement|tc_statement_audit" +
            "|cci_statement|cci_statement_audit|cce_statement|cce_statement_audit|ccf_statement|ccf_statement_audit)", message = "只允许填写特定值")
    private String cmd;
