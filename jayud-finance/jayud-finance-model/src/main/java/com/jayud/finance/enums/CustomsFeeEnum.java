...
public enum CustomsFeeEnum {
    ...
    GUO_JIAN_FEI("GJF", "国检费", "国检费", "C0006", "代理报关服务", "单证费"),
    ...
    KSSMF("KSSMF", "快速扫描费", "C0017", "快速扫描费", "代理报关服务费", "单证费"),
    JKHDF("JKHDF", "进口换单费", "C0033", "进口换单代垫费", "代理报关服务费", "单证费"),
    BHF("BHF", "编号费", "C0020", "编号费", "代理报关服务费", "代理服务费"),
    GCF("GCF", "改船费", "C0019", "改船费", "代理报关服务费", "单证费"),
    BCLHF("BCLHF", "驳船理货费", "C0018", "驳船理货费", "代理报关服务费", "单证费"),
    sjhz_cost("sjhz_cost", "商检换证费", "C0021", "商检换证费", "代理报关服务费", "单证费"),
    sjbj_cost("sjbj_cost", "商检报检费", "C0014", "代理报检费", "代理报关服务费", "单证费"),
    xzxd_cost("xzxd_cost", "熏蒸消毒费", "C0015", "其他收入", "代理报关服务费", "报关服务费"),
    sjdd_cost("sjdd_cost", "商检打单费", "C0014", "代理报检费", "代理报关服务费", "单证费"),
    CYDL("CYDL", "查验代理费", "C0116", "查验费", "代理报关服务费", "#N/A"),
    TTSYF("TTSYF","抬头费","C0015","其他收入","代理报关服务","报关服务费"),

    //    tcf_cost("tcf_cost", "舱单费", "C0002", "舱单费", "代理报关服务费", "单证费"),
    qtz_cost("qtz_cost", "其他支出", "C0015", "其他收入", "代理报关服务费", "报关服务费"),
//    DL("DL", "代理费", "C0005", "代理费", "代理报关服务费", "代理服务费"),
    PTFWF("PTFWF", "平台服务费", "C0008", "网付代理费", "代理报关服务费", "代理服务费"),
    XFS("XFS", "消费税", "C0038", "进口消费税", "代理报关服务费", "代垫税金"),
    FDLHF("FDLHF", "分单理货费", "C0084", "理货费", "代理报关服务费", "装卸费"),
    BYJ("BYJ", "备用金", "#N/A", "#N/A", "代理报关服务费", "#N/A"),
    sjdl_cost("sjdl_cost", "商检代理", "C0014", "代理报检费", "代理报关服务费", "单证费"),
    kd_cost("kd_cost", "快递费", "C4127", "快递费", "代理报关服务费", "#N/A"),
    qtc_cost("qtc_cost", "其他代垫费", "C0015", "其他收入", "代理报关服务费", "报关服务费"),
