...
import static com.jayud.finance.enums.KingdeeResultEnum.LOGIN_FAIL;
...
//            log.info("默认账套查询结果：{}", result);
     ...
     * @return
     */
    private JSONArray format(String result, String[] fieldKeys) {
    ...
    public Object Name2Code(Object reqForm) {
        ...
        if (reqForm instanceof ReceivableHeaderForm) {
            ...
            //币别
            Optional<Currency> currency = baseService.get(result.getCurrency(), Currency.class);
