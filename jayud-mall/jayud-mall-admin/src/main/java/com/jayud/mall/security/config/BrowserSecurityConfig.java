...
//                .csrf().disable();
        ...
        http
            ...
            .and()
                ...
                .tokenValiditySeconds(60*60*24) // remember 过期时间，单为秒 有效期24小时
            ...
            .and()
                ...
                .antMatchers("/authentication/require",
                        ...
                        "/session/invalid",
                        "/signout/success",
                        "/promoteorder/savePromoteOrder",
                        "/promotepompany/findPromoteCompanyByCompanyId").permitAll() // 登录跳转 URL 无需认证
