...
@ApiModel(value="WaybillTaskRelevance", description="运单(订单）任务关联")
public class WaybillTaskRelevance extends Model<WaybillTaskRelevance> {
    ...
    @ApiModelProperty(value = "任务代码(waybill_task task_code)", position = 3)
    @JSONField(ordinal = 3)
    private String taskCode;

    @ApiModelProperty(value = "任务名(waybill_task task_name)", position = 4)
    @JSONField(ordinal = 4)
