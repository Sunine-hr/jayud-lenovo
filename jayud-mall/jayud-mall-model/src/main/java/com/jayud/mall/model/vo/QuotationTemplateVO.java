...
public class QuotationTemplateVO {
    ...
    /*国家基础信息表:country*/
    @ApiModelProperty(value = "目的国家名称country.name", position = 34)
