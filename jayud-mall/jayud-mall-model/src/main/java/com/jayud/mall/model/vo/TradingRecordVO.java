...
public class TradingRecordVO {
    ...
    //客户(公司)名称
    @ApiModelProperty(value = "客户(公司)名称", position = 16)
    @JSONField(ordinal = 16)
    private String customerName;

    //币种代码
    @ApiModelProperty(value = "币种代码", position = 17)
    @JSONField(ordinal = 17)
    private String currencyCode;

    //币种名称
    @ApiModelProperty(value = "币种名称", position = 18)
    @JSONField(ordinal = 18)
    private String currencyName;

    //创建人名称（customer user_name）
    @ApiModelProperty(value = "创建人名称（customer user_name）", position = 19)
    @JSONField(ordinal = 19)
    private String creatorName;

    //审核人名称（system_user name）
    @ApiModelProperty(value = "审核人名称（system_user name）", position = 20)
