...
import com.jayud.mall.security.utils.R;
import com.jayud.mall.security.utils.ResponseUtil;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, 
        ...
        //把token放入到redis
        redisTemplate.opsForValue().set(token, JSONObject.toJSONString(user),24*60*60, TimeUnit.SECONDS);
        //返回token
