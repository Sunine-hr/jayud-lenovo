        ...
        for (GoodsVO goods : goodsList) {
            if (this.id.equals(goods.getBusinessId())
                ...
                sb.append(goods.getName())
                        .append(" ").append(goods.getPlateAmount() == null ? 0 : goods.getPlateAmount()).append(goods.getPlateUnit()== null ? "" : goods.getPlateUnit())
                        .append(",").append(goods.getBulkCargoAmount()== null ? 0 : goods.getBulkCargoAmount()).append(goods.getBulkCargoUnit()== null ? "" : goods.getBulkCargoUnit())
