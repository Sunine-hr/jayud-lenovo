...
public class AppletOrderRecordVO extends Model<AppletOrderRecordVO> {
    ...
    private List<AppletOrderRecordVO> pickUpGoodsList = new ArrayList<>();

    @ApiModelProperty(value = "送货信息集合")
    private List<AppletOrderRecordVO> receivingGoodsList = new ArrayList<>();
