...
public class BusinessDevEvaluationVO extends BasePageForm {
    ...
    @ApiModelProperty(value = "国家企业信用(0:异常,1:无异常)")
    private String stateCreditDesc;
    ...
    public void setStateCredit(Integer stateCredit) {
        this.stateCredit = stateCredit;
        this.stateCreditDesc = CreditStatusEnum.getDesc(stateCredit);
    }
    ...
    public void setLevel(Integer level) {
        this.level = level;
        this.levelDesc = CustomsCreditRatingEnum.getDesc(level);
    }
    ...
    public String getOrderStatus() {
        LocalDateTime dateOne = this.createTime.plusMonths(11);
