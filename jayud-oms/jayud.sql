...
ALTER TABLE `jayud-test`.`vehicle_info`
...
ALTER TABLE `jayud-test`.`driver_info`
...
CREATE TABLE `jayud-test`.`Untitled`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '地址id',
  `type` char(10) NOT NULL COMMENT '地址类型（0 提货地址 1送货地址）',
  `customer_id` bigint(20) NOT NULL COMMENT '客户地址id',
  ...
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '1' COMMENT '状态（0无效 1有效）',
