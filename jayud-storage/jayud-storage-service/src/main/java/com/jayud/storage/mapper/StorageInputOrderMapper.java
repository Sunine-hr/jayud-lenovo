...
import com.jayud.storage.model.bo.QueryInOrderForm;
...
public interface StorageInputOrderMapper extends BaseMapper<StorageInputOrder> {
    ...
    IPage<StorageInputOrderNumberVO> findOrderRecordByPage(@Param("page")Page<StorageInputOrderNumberVO> page,@Param("form") QueryInOrderForm form);
}
