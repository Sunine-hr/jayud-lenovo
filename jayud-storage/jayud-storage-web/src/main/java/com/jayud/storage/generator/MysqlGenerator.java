package com.jayud.storage.generator;
...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        String[] models = {
                "jayud-storage\\jayud-storage-model",
                "jayud-storage\\jayud-storage-service",
                "jayud-storage\\jayud-storage-web"
        };
        for (String model : models) {
            shell(model, "out_goods_location_record");
        ...
        if (path.contains("service")) {
            ...
            focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return path + "/src/main/resources/com.jayud.storage.mapper"
