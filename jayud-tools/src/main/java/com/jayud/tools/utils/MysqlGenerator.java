...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        String[] models = {"jayud-tools"};
        for (String model : models) {
            shell(model,"fba_order");
    ...
    private static void shell(String model, String table) {
        ...
        dsc.setUrl("jdbc:mysql://113.100.140.250:8097/jayud_platform");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return path + "/src/main/resources/com/jayud/tools/mapper"
