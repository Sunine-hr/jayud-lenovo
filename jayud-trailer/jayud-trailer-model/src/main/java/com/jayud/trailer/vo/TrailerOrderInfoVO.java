...
@ApiModel(value = "TrailerOrder对象", description = "拖车订单详情表")
public class TrailerOrderInfoVO extends Model<TrailerOrderInfoVO> {
    ...
    @ApiModelProperty(value = "拖车订单地址")
    private List<OrderDeliveryAddress> deliveryAddresses;

    @ApiModelProperty(value = "派车信息")
    private TrailerDispatchInfoVO trailerDispatchInfoVO;
    ...
    public void assemblyVehicleInfos(Object vehicleInfos) {
        if (vehicleInfos == null || this.trailerDispatchInfoVO == null
                || this.trailerDispatchInfoVO.getPlateNumber() == null) {
            return;
        }
