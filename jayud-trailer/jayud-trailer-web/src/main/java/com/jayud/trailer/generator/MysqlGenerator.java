package com.jayud.trailer.generator;
...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        String[] models = {"jayud-trailer\\jayud-trailer-model",
                "jayud-trailer\\jayud-trailer-service",
                "jayud-trailer\\jayud-trailer-web"};
    ...
    private static void shell(String model, String table) {
        ...
        pc.setParent("com.jayud.trailer");
        pc.setEntity("po");
        ...
        if (path.contains("service")) {
            ...
            focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return path + "/src/main/resources/com/jayud/trailer/mapper"
