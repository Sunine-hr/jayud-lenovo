...
@ApiModel(value="出库播种记录对象", description="出库播种记录")
public class WmsOutboundSeedingRecord extends SysBaseEntity {


    @ApiModelProperty(value = "出库播种id")
    private Long seedingId;
